...
export default function PendientePage() {
    return (
        <div className="min-h-screen bg-[#F8F9FC] flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-[var(--card)] rounded-2xl shadow-sm border border-[var(--border)] p-10 text-center">
                {/* Icon */}
                ...
                <p className="text-[var(--muted)] text-sm leading-relaxed mb-8">
                    ...
                    <span className="font-medium text-[var(--foreground)]">Por favor, espera a ser aprobado.</span>
                </p>

                <div className="flex flex-col gap-3">
                    <Button
                        variant="outline"
                        className="w-full text-[var(--muted)] border-[var(--border)] hover:bg-[var(--bg)]"
